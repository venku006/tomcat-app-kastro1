    ...
    <section id="home" class="hero">
        ...
        <div class="hero-content">
            <div class="hero-text">
                <h1 class="hero-title">
                    Welcome to 
                    <span class="gradient-text">Jenkins Docker Kubernetes and Terraform Training</span>
                ...
                <div class="instructor-info">
                    ...
                    <div class="instructor-details">
                        ...
                        <p>Senior DevOps Engineer & Certified Trainer</p>
                    </div>
                </div>
        ...
        <div class="instructor-container">
            <div class="instructor-profile">
                ...
                <div class="profile-content">
                    ...
                    <p>With over 8 years of experience in DevOps and Cloud Engineering, I've helped numerous organizations transform their development and deployment processes. My hands-on approach ensures students gain practical skills that are immediately applicable in real-world scenarios.</p>
    ...
    <footer class="footer">
        <div class="footer-content">
            <div class="footer-section">
                <h4>DevOps Training Academy</h4>
                <p>Empowering the next generation of DevOps professionals</p>
            </div>
            <div class="footer-section">
                <h4>Contact</h4>
                <p><i class="fas fa-envelope"></i> kastro.kiran@training.com</p>
        ...
        <div class="footer-bottom">
            <p>&copy; 2024 DevOps Training Academy. All rights reserved.</p>
        </div>
    </footer>
